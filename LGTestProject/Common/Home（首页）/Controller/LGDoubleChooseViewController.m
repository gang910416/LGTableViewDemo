//
//  LGDoubleChooseViewController.m
//  LGTestProject
//
...
@interface LGDoubleChooseViewController ()
...
@implementation LGDoubleChooseViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    LGChooseTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"Cell"];
...
- (UITableView *)tableView{
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, kNavigationHeight, SCREEN_W, SCREEN_H-64)];
        _tableView.dataSource      = self;
        _tableView.delegate        = self;
        _tableView.backgroundColor = [UIColor whiteColor];
        _tableView.tableFooterView = [[UIView alloc] init];
        [_tableView registerClass:[LGChooseTableViewCell class] forCellReuseIdentifier:@"Cell"];
    }
    return _tableView;
}
