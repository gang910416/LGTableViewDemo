...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"collectionView 常见的案例";
//    [self createNavgationBarWith:@"white_search" isLeftBarButton:YES];
//    [self createNavgationBarWith:@"ewm" isLeftBarButton:NO];
    self.dataSource = @[@"collectionView 瀑布流",@"collectionView 简单实用"];
    self.classNames = @[@"LGWaterfallViewController",@"LGCollectionNomalViewController"];
