...
//不定按钮
+ (void)showAlertViewWithTitle:(NSString *)title message:(NSString *)message cancelButtonTitle:(NSString *)cancelButtonTitle buttonIndexBlock:(JXTAlertClickBlock)buttonIndexBlock otherButtonTitles:(NSArray *)otherButtonTitles
{
    if (!(title.length > 0) && message.length > 0) {
        title = @"";
    }
    ...
    {
        for (NSString *arg in otherButtonTitles)
        {
